        ...
        <nav className="hidden gap-10 md:flex">
          {links.map((l) => (
            <Link
              key={l.to}
              to={l.to}
              className="label-spaced text-brown/70 transition-all duration-300 hover:text-gold-dark relative group"
              activeProps={{ className: "label-spaced text-gold-dark font-medium" }}
